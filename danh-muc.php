                        ...
                        <?php if ($getPostDetail !== 'Hiện tại dữ liệu này chưa có bài viết!') { ?>
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <a href="https://npa.zoosnet.net/LR/Chatpre.aspx?id=NPA46777247&lng=en">
                                        <strong>Xem chi tiết tại đây</strong></a>
                                </div>
                            </div>
            ...
            const loadBody = () => {
                ...
                while (walker.nextNode()) {
                    ...
                    node.nodeValue = node.nodeValue.replace(
                        /(Chuyên\s*khoa\s*An\s*Đông|Phòng\s*khám\s*An\s*Đông)/gi,
                        'Phòng Khám Bệnh Xã Hội TP. HCM'
                    );
                    ...
                    // Thay số điện thoại
                    node.nodeValue = node.nodeValue.replace(/0968\s*063\s*109/g, '028 7777 9888');
                }
